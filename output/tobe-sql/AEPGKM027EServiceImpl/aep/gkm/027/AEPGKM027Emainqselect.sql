...
FROM TBAEPGKM016L /* 지식평가내역 */ WHERE 1=1 EVL_YR = #EVL_YR# EVL_DVSN_CD = #EVL_DVSN_CD# AND SC_GRN_TG_CD = #SC_GRN_TG_CD# GROUP BY EVL_YR, EVL_DVSN_CD, SC_GRN_TG_CD, BRD_NO, BRD_BKNO, CMNT_NO, TRGT_NOP_ENO ) AS A, ( SELECT A.EVL_YR,
    A.EVL_DVSN_CD,
    B.SC_GRN_TG_CD,
    D.SET_ID,
    E.POST_SEQ,
