SELECT T1.CVLCPT_SECD /* 민원구분코드 */,
    ...
    T1.CRU_TELNO /* 부패전화번호 */,
    TO_CHAR(T2.CRU_HNDT_DT,'YYYYMMDD') AS CRU_HNDT_DT /* 부패배부일시 */,
