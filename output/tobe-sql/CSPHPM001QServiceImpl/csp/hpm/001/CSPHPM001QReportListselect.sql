SELECT '1' AS NUM,
    ...
    A.RDCNT,
    CASE WHEN A.CATEGORY = 'Y' THEN '해당' WHEN NVL(A.CATEGORY,'N') = 'N' THEN '미해당' END AS CATEGORY,
    A.PARNTSCTT_NO,
    A.ANSWER_AT,
    A.ANSWER_LC,
    A.USE_AT,
    ...
    CASE WHEN NVL(A.ORG_REGI_YN,'N') = 'N' THEN '미등록' WHEN A.ORG_REGI_YN = 'Y' THEN '등록' END AS ORG_REGI_YN,
    A.INSTITUTION,
    ...
    A.QNA_ANSWER
FROM TBCSPTSM002L a LEFT OUTER JOIN TBDCMACM001M b ON A.FRST_REGISTER_ID = B.USER_ID WHERE BBS_ID='BBSMSTR_100000000032' AND A.USE_AT = 'Y' AND A.NTT_ID = #strNttId#