...
FROM TBCSPOEP006M T1 WHERE 1=1 AND (TO_CHAR(TO_DATE(T1.NDTY_DT, 'YYYYMMDD'), 'YYYYMMDD') BETWEEN #strNDTY_DTS# AND #strNDTY_DTE#) AND T1.NDTY_TIT_NM LIKE '%'||#strNDTY_TIT_NM#||'%' ORDER BY T1.NDTY_DOC_SEQ DESC