SELECT NVL2(A.LINK_YR, A.LINK_YR, '합계') AS LINK_YR /* 연계년도 */,
    ...
    DECODE(NVL2(A.EDU_DVSN_NM, A.EDU_DVSN_NM, '소계'), '소계', '', NVL2(A.CRS_NM, A.CRS_NM, '소계')) AS CRS_NM /* 과정명 */,
    A.CRS_CDN /* 과정기수 */,
    A.CRS_CD,
    A.EDU_PRD_TXT,
    A.ONTM_NOP_CNT,
