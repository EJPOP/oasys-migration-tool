SELECT A.LINK_YR /* 연계년도 */,
    ...
    A.CRS_CD,
    A.CRS_CDN /* 과정기수 */,
    (SUBSTR(A.EDU_BGNG_YMD, 0, 4) || '-' || SUBSTR(A.EDU_BGNG_YMD, 5, 2) || '-' || SUBSTR(A.EDU_BGNG_YMD, 7, 2) || '~' || SUBSTR(A.EDU_END_YMD, 0, 4) || '-' || SUBSTR(A.EDU_END_YMD, 5, 2) || '-' || SUBSTR(A.EDU_END_YMD, 7, 2)) AS SUBSTR,
    A.ONTM_NOP_CNT,
    A.TANE_ID,
    A.AVR_TG_CNT,
