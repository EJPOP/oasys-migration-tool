SELECT DECODE(#strHndlStaDvsnCd#, 0, '전체', F_CODE_NM ('1000587', #strHndlStaDvsnCd#)) AS #STRHNDLSTADVSNCD# /* 처리구분 */,
    ...
    TO_CHAR(TO_DATE(D1.REG_YMD), 'YYYY.MM.DD') AS REG_YMD /* 등록일자 */,
    F_ORG_INFO(D1.INST_CD,'1') || '-' || F_CODE_NM('1000202', D1.OCRN_SECD) || '-' || D1.NTFCTN_SQNO AS F_ORG_INFO /* 통보사항번호 */,
    D1.RSCH_ASMT_TTL AS RSCH_ASMT_TTL /* 연구과제제목 */,
    D1.VIOL_NM AS VIOL_NM /* 비위명 */,
    D2.DFNT_NMS AS DFNT_NMS /* 관계자명 */,
    TO_CHAR(TO_DATE(D1.NTFCTN_RCPT_YMD), 'YYYY.MM.DD') AS NTFCTN_RCPT_YMD /* 통보접수일자 */,
    ...
    TO_CHAR(TO_DATE(D1.CPLT_YMD), 'YYYY.MM.DD') AS CPLT_YMD /* 완결일자 */
