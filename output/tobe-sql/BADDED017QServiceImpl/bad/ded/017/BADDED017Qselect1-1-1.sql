SELECT BZTRP_YR /* 출장년도 */,
    ...
    ALL_COST,
    '' AS SORTER,
    NVL(BZTRP_TRVEXP_FDEXP, 0) + NVL(BTEXP_CRTR_AMT, 0) AS BZTRP_TRVEXP_FDEXP /* 출장여비식비 */,
    NVL(BZTRP_TRVEXP_FDEXP, 0) + NVL(BTEXP_CRTR_AMT, 0) + NVL(LDG_CST, 0) + NVL(RL_FARE_AMT, 0) AS BZTRP_TRVEXP_FDEXP /* 출장여비식비 */
FROM ( SELECT D1.BZTRP_YR AS BZTRP_YR /* 출장년도 */,
    ...
    F_DPT_INFO(D1.OGDP_DEPT_CD, '4') AS F_DPT_INFO,
