SELECT /*CSPDCP711OINSPCP013SucSelect*/ D1.TPOF_HMPG_APLY_NO AS TPOF_HMPG_APLY_NO /* 제보누리집신청번호 */,
    ...
    D1.TPOF_NM /* 제보명 */,
    D3.TPOF_CN /* 제보내용 */
FROM TB_CSPDCP101M D1 ,TB_CSPDCP103M D2 ,TB_CSPDCP102M D3 WHERE 1=1 AND D1.CVLCPT_CLM_SECD = D2.CVLCPT_CLM_SECD(+) AND D1.TPOF_RCPT_NO = D2.TPOF_RCPT_NO(+) AND D1.TPOF_RCPT_YR = D2.TPOF_RCPT_YR(+) AND D1.CVLCPT_CLM_SECD = #CLM_SECD# AND D1.TPOF_RCPT_NO = #CVLCPT_RCPT_RCPT# AND D1.TPOF_RCPT_YR = #CVLCPT_RCPT_YR# AND D1.CVLCPT_CLM_SECD = D3.CVLCPT_CLM_SECD(+) AND D1.TPOF_RCPT_NO = D3.TPOF_RCPT_NO(+) AND D1.TPOF_RCPT_YR = D3.TPOF_RCPT_YR(+)