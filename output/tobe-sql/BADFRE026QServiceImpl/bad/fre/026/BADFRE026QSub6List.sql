SELECT F_DPT_INFO(M1.SRECS_DEPT_CD, '1') AS F_DPT_INFO,
    ...
    NVL(SUM( CASE WHEN M1.TERM_DT BETWEEN 0 AND 60 THEN NVL(M1.SRECS_STATS_CONT, 1) ELSE 0 END ), 0) AS TERM_DT /* 3개월 이내 */,
