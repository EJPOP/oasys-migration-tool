SELECT M1.GUBUN,
    ...
    NVL(SUM( CASE WHEN M1.TERM_DT BETWEEN 0 AND 60 THEN NVL(M1.SRECS_STATS_CONT, 1) ELSE 0 END ), 0) AS TERM_DT /* 2개월 이내 */,
    NVL(SUM( CASE WHEN M1.TERM_DT > 60 THEN NVL(M1.SRECS_STATS_CONT, 1) ELSE 0 END ), 0) AS TERM_DT /* 기간초과처리건수 계 */,
    NVL(SUM( CASE WHEN M1.TERM_DT BETWEEN 60 AND 180 THEN NVL(M1.SRECS_STATS_CONT, 1) ELSE 0 END ), 0) AS TERM_DT /* 기간초과처리건수 4에서 6월 */,
