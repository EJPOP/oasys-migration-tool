...
FROM TBCSPMWF011M WHERE HLDY = T1.DT AND BOKG_DVSN_CD = '3') > 0 THEN 'Y' /* 임시휴일 적용 - 2019.07.29 yyh */ ELSE 'N' END AS HOLIDAY_YN FROM ( SELECT TO_CHAR(LEVEL + 2 + (SELECT NEXT_DAY(TO_DATE(BASE_DATE_CTE.BASE_DATE), 6) - 7
