...
FROM TBCSPMWF013M T1 ,TBCSPMWF009M T2 ,BASE T3 ,TBCSPMWF012M T4 WHERE 1=1 AND T1.SCO_HST_SNO = T2.SCO_HST_SNO AND T1.SCO_SNO = T2.SCO_SNO AND T2.BOKG_DVSN_CD = '3' AND T1.BOKG_APL_DH = T4.BOKG_APL_DH(+) AND T1.BOKG_DT BETWEEN T3.BGNG_YMD AND T3.END_YMD AND T1.BOKG_PEN_CNB = #strBokgPenCnb# ORDER BY T1.BOKG_DT ,T1.SCO_SNO