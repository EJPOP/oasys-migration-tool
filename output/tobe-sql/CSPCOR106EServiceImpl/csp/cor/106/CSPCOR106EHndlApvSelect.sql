...
FROM TBDCMACM023L WHERE APV_SNO <> '1' AND APRVR_KDCD NOT IN ('4','6','7') AND ATRZ_DOC_NO = ( SELECT CRU_PRCS_ATRZ_DOC_NO /* 부패처리결재문서번호 */
FROM TBCSPCOR104M S1 WHERE S1.CVLCPT_SECD = #CVLCPT_SECD# AND S1.CVLCPT_RCPT_YR = #CVLCPT_RCPT_YR# AND S1.CVLCPT_RCPT_NO = #CVLCPT_RCPT_NO# ) ) )