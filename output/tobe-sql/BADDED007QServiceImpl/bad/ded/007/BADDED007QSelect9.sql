...
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD = '1000007') DDD , TBDCMACM002M EEE , (SELECT CD,
    CD_NM
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD = '1000030') FFF WHERE 1=1 AND BBB.INST_CD = AAA.INST_CD AND CCC.CD = AAA.INST_SECD AND DDD.CD = AAA.ADT_KDCD AND EEE.SRECS_DEPT_CD = AAA.SPRVSN_DEPT_CD AND FFF.CD = AAA.ADT_BZTRP_KDCD ORDER BY AAA.INST_CD, AAA.BZTRP_YR, AAA.BZTRP_SQNO