...
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD = '1000007') CCC , TBDCMACM001M DDD , (SELECT CD,
    CD_NM
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD = '1000030') EEE , TBDCMACM002M FFF WHERE AAA.INST_CD = BBB.INST_CD AND AAA.SPRVSN_DEPT_CD = FFF.SRECS_DEPT_CD AND AAA.ADT_KDCD = CCC.CD AND AAA.BZTRP_TL_ENO = DDD.TRGT_NOP_ENO AND AAA.ADT_BZTRP_KDCD = EEE.CD