...
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD = '1000007') CCC , TBDCMACM001M DDD , (SELECT CD,
    CD_NM
FROM TBDCMACM013C WHERE CMM_CD_DVSN_CD='1000030') EEE WHERE BBB.INST_CD = AAA.INST_CD AND EEE.CD = AAA.ADT_BZTRP_KDCD AND CCC.CD = AAA.ADT_KDCD AND DDD.TRGT_NOP_ENO = AAA.BZTRP_TL_ENO ORDER BY BZTRP_YR, BZTRP_SQNO