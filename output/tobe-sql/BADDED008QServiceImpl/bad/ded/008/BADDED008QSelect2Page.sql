SELECT B.GUBUN AS GUBUN,
    ...
    B.FULL_AUD_NO,
    B.ADT_MTTR_NM AS ADT_MTTR_NM /* 감사사항명 */,
    B.INST_CONT AS INST_CONT /* 기관개수 */,
    TO_CHAR(TO_DATE(B.ADT_BGNG_YMD),'YYYY.MM.DD') || '~' || TO_CHAR(TO_DATE(B.ADT_END_YMD),'YYYY.MM.DD') AS TO_CHAR,
    B.ADT_DCN /* 감사일수 */,
    B.IN_PSON_TOT_CNT || '(' || B.EXT_PSON_TOT_CNT || ')' AS IN_PSON_TOT_CNT,
    A.PROF_RBPRSN_INST_NM AS PROF_RBPRSN_INST_NM /* 증명책임자기관명 */,
    TO_CHAR(TO_DATE(B.SDATE),'YYYY.MM.DD') || '~' || TO_CHAR(TO_DATE(B.EDATE),'YYYY.MM.DD') AS TO_CHAR,
    B.ADT_DCN /* 감사일수 */,
    B.IN_PSON_CNT || '/' || B.IN_PSON_MAN_CNT AS IN_PSON_CNT,
    B.EXT_PSON_CNT || '/' || B.EXT_PSON_MAN_CNT AS EXT_PSON_CNT
