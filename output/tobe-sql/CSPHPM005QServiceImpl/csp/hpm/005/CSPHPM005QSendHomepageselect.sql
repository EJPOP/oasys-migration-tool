...
FROM tbdcmacm002m WHERE USE_YN = 'Y' AND SRECS_DEPT_CD = A.FMDA_DEPT ) AS FMDA_DEPT_NM , A.FMDA_PART , A.FMDA_PROC , A.FMDA_DT , A.FMDA_SJ , A.FMDA_RDCNT , A.FMDA_OPN_REGCNT , A.ENAIS_PST_ATCH_FILE_ID as CVLCPT_DOC_ID , TO_CHAR(A.FMDA_PUBLIC_DT, 'YYYY-MM-DD') AS FMDA_PUBLIC_DT , A.FMDA_PUBLIC_YN , #FLAG# as REG_SECD , A.USE_AT , A.FMDA_UP_DT FROM TBCSPTSM002M A WHERE USE_AT = 'Y' AND FMDA_IDX = #FMDA_IDX#