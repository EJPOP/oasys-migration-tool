DECLARE BEGIN UPDATE TB_BADDED145M SET CMPTN_YN = 'N' /* 완료여부 */,  LAST_USER_ID = #LAST_USER_ID# /* 최종사용자아이디 */,  LAST_PRCS_DEPT_CD = #LAST_PRCS_DEPT_CD# /* 최종처리부서코드 */,  LAST_MENU_ID = #LAST_MENU_ID# /* 최종메뉴아이디 */,  LAST_MDFCN_DT = SYSDATE /* 최종수정일시 */WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = '0010600' AND SBCN_SECD = 'E10' AND CMPTN_YN = 'Y' AND CVLCPT_DOC_ID IN (SELECT DISTINCT AS CVLCPT_DOC_ID
FROM TB_BADDED145M WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = '0010600' AND SBCN_SECD = 'D10') ; INSERT INTO TB_BADDED145H (HSTRY_SECD, FNNC_INFO_SBMSN_RQT_HSTRY_SQNO, CVLCPT_HSTRY_DT, HSTRY_USER_ID, CVLCPT_ADT_YR, ADT_NO, ADT_STP_SECD, CVLCPT_DOC_ID, APRVR_JBPS_SECD, INCDNT_SQNO, ADT_KDCD, ADT_GRNT_NO, RPTP_FLD_ID, INCDNT_KDCD, LIST_SQNO, SBCN_SECD, INCDNT_FLD_CN, SBCM_AGND_NM, INDCT_TTL, QPB_YN, QPB_YMD, ADTR_NM, DTL_DOC_NO, DATA_INPT_SECD, SNTHS_DPP_SE_YN, SCRT_YN /* 증권여부 */, SRECS_SORT_SQNO, DPP_RVWR_ENO, CMPTN_YN, FRST_USER_ID, LAST_USER_ID, LAST_PRCS_DEPT_CD, LAST_MENU_ID, FRST_REG_DT, LAST_MDFCN_DT, RFRNC_DOC_ID) SELECT 'U',
...
FROM TB_BADDED145M WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = '0010600' AND SBCN_SECD = 'E10' AND CMPTN_YN = 'Y' AND CVLCPT_DOC_ID IN (SELECT DISTINCT AS CVLCPT_DOC_ID
FROM TB_BADDED145M WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = '0010600' AND SBCN_SECD = 'D10') ; END;