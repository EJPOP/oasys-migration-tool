DECLARE BEGIN UPDATE TB_BADDED145M SET CMPTN_YN = 'Y' /* 완료여부 */,  LAST_USER_ID = #LAST_USER_ID# /* 최종사용자아이디 */,  LAST_PRCS_DEPT_CD = #LAST_PRCS_DEPT_CD# /* 최종처리부서코드 */,  LAST_MENU_ID = #LAST_MENU_ID# /* 최종메뉴아이디 */,  LAST_MDFCN_DT = SYSDATE /* 최종수정일시 */WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = 'A1070' AND SBCN_SECD = 'E10' AND CVLCPT_DOC_ID IN (SELECT DISTINCT AS CVLCPT_DOC_ID
...
FROM TB_BADDED145M WHERE CVLCPT_ADT_YR = #CVLCPT_ADT_YR# AND ADT_NO = #ADT_NO# AND APRVR_JBPS_SECD = 'A1070' AND SBCN_SECD = 'E10' AND CVLCPT_DOC_ID IN (SELECT DISTINCT AS CVLCPT_DOC_ID
