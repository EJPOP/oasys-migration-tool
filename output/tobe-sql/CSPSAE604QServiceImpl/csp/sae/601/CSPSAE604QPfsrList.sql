SELECT NVL2(A.LINK_YR, A.LINK_YR, '합계') AS LINK_YR /* 연계년도 */,
    DECODE(NVL2(A.LINK_YR, A.LINK_YR, '합계'), '합계', '', NVL2(A.PFSR_DVSN_NM, A.PFSR_DVSN_NM, '소계')) AS NVL2,
    A.PFSR_ID,
    DECODE(NVL2(A.PFSR_DVSN_NM, A.PFSR_DVSN_NM, '소계'), '소계', '', NVL2(A.INFO_RLPR_NM, A.INFO_RLPR_NM, '소계')) AS INFO_RLPR_NM /* 정보관계자명 */,
    ...
    A.EDU_CAT_CD,
    A.CRS_CD,
    NVL2(A.CRS_CDN, A.CRS_CDN, COUNT(A.CRS_CDN)) AS CRS_CDN /* 과정기수 */,
