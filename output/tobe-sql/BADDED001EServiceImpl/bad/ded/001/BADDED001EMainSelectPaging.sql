...
FROM TB_BADDED001M WHERE CVLCPT_ADT_YR = T1.INTG_ADT_YR AND ADT_NO = T1.INTG_ADT_NO) AS ITGT_AUD_GRN_NO /*통합감사부여번호 - 2016.05.26 yyh*/ , T1.ITGT_AUD_SBJ_NM AS ITGT_AUD_SBJ_NM /*통합감사사항명 - 2015.09.15 yyh*/ , T1.ITGT_AUD_INFO AS ITGT_AUD_INFO /*해당건을 통합 감사사항으로 사용하는 건 - 2015.09.15 yyh*/ , T1.DVS_AUD_YR_NO_KND_CD AS DVS_AUD_YR_NO_KND_CD , T1.ITGT_AUD_YR_NO_KND_CD AS ITGT_AUD_YR_NO_KND_CD , T1.ADT_CNTRL_SECD AS ADT_CNTRL_SECD /*감사통제코드 - 2016.06.03 yyh */ , T1.AUD_CTRL_NM AS AUD_CTRL_NM /*감사통제코드명 - 2016.06.03 yyh */ FROM ( SELECT D1.CVLCPT_ADT_YR AS CVLCPT_ADT_YR /* 민원감사년도 */,
