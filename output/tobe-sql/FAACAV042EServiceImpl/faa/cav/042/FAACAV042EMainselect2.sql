/* faa/cav/042/FAACAV042EMainselect2 */ SELECT F_AV_BLL_COPT_CD_NM(A.JRSD_CD) AS F_AV_BLL_COPT_CD_NM,
...
FROM TWFAACAV003M A WHERE BLL_KDCD IN('22','23','24') AND GVMNFC_OPER_EPS_RCDB_PBOFC_SQNO = '000' AND PROF_RBPRSN_ABL_YMD >= #strYr#||'00' AND PROF_RBPRSN_CRT_YMD = '10') THEN #strYr#||'04' ELSE #strYr#||'04' END)) ORDER BY JRSD_CD, ACNTG_CD, BLL_KDCD, PROF_RBPRSN_SQNO, GVMNFC_OPER_EPS_RCDB_PBOFC_SQNO