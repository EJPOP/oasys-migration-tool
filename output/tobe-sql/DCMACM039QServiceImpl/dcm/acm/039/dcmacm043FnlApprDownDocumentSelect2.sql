...
FROM TBDCMACM023L WHERE APRVR_ENO = #APRVR_ENO# AND APRVR_KDCD <> '4' /*협조한 문서는 보이지 않도록*/ ) D3 , (SELECT D1.ATRZ_DOC_NO /* 결재문서번호 */,
