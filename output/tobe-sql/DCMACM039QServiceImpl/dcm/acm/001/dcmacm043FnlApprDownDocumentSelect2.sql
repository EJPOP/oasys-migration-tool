...
FROM TBDCMACM023L WHERE APRVR_ENO = #APRVR_ENO# AND CASE WHEN APRVR_KDCD ='9' AND READ_YN = 'Y' AND APVR_STA_CD ='202' THEN '1' WHEN APRVR_KDCD ='9' AND NVL(READ_YN,'N') = 'N' AND APVR_STA_CD ='202' THEN '0' ELSE '1' END = '1' AND SUBSTR(APVR_STA_CD,0,1) IN ('2','4') AND APRVR_JBPS_SECD = '0055700' ) D3 , (SELECT D1.ATRZ_DOC_NO /* 결재문서번호 */,
