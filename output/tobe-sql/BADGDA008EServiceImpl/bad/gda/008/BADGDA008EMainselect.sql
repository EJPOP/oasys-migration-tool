SELECT F_ORG_INFO(INST_CD,'1') || '-' || LINK_YR || '-' || FRS_MDM_SQNO AS F_ORG_INFO /* 통보번호 */,
    ...
    CTRT_AMT /* 계약금액 */ /* ,APS_EVL_AMT 감정평가액 */ AS CTRT_AMT /* 계약금액 */,
...
FROM TB_BADGDA004M /* 관련법령 통지통보 */ WHERE 1=1 AND STT_RCPT_STTS_SECD != '51' AND SRECS_DEPT_CD IN (SELECT SRECS_DEPT_CD /* 심사재심의부서코드 */
