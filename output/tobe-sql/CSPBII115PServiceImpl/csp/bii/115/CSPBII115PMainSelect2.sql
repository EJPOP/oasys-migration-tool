...
FROM TB_CSPBII100M A /* 감사정보기본 */ , TB_CSPBII101L B /* 감사정보내역 */ , (SELECT D.ATRZ_DOC_NO /* 결재문서번호 */,
...
FROM VW ) AND A.ATRZ_DOC_NO = #ATRZ_DOC_NO# AND A.NTFCTN_RCPT_YMD BETWEEN #strStrAcpDt# AND #strEndAcpDt# AND A.CRU_RCPT_DT BETWEEN #strStrAcpDh# AND #strEndAcpDh# AND A.HNDT_YMD BETWEEN #strStrAcpDt# AND #strEndAcpDt# AND A.OVRL_PIC_ENO = #OVRL_PIC_ENO# UNION ALL SELECT /* 감사정보 상세조회 영역 */ A.INFO_YR AS INFO_YR /* 정보년도 */,
    A.FRS_MDM_SQNO /* 포렌식매체순번 */,
    A.RLS_YN /* 공개여부 */,
    A.ETC_LBSVC_MNG_DEPT_CD /* 기타용역관리부서코드 */
