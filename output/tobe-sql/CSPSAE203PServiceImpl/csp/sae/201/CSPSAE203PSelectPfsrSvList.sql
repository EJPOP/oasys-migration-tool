SELECT A.BLL_SBJCT_NM || '[' || A.INFO_RLPR_NM || ']' AS BLL_SBJCT_NM /* 계산서과목명 */,
    A.SV_DVSN_NM,
    NVL(DECODE(C.TOT_STFT, 0, 0, ROUND(B.EDU_STFT_TXT_1 / C.TOT_STFT * 100, 0)), 0) AS TOT_STFT,
    NVL(DECODE(C.TOT_STFT, 0, 0, ROUND(B.EDU_STFT_TXT_2 / C.TOT_STFT * 100, 0)), 0) AS TOT_STFT,
    NVL(DECODE(C.TOT_STFT, 0, 0, ROUND(B.EDU_STFT_TXT_3 / C.TOT_STFT * 100, 0)), 0) AS TOT_STFT,
    NVL(DECODE(C.TOT_STFT, 0, 0, ROUND(B.EDU_STFT_TXT_4 / C.TOT_STFT * 100, 0)), 0) AS TOT_STFT,
    NVL(DECODE(C.TOT_STFT, 0, 0, ROUND(B.EDU_STFT_TXT_5 / C.TOT_STFT * 100, 0)), 0) AS TOT_STFT,
