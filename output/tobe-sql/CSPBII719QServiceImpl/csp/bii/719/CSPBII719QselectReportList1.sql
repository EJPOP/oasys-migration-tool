SELECT to_char(to_date(#strStrDt#),'yyyy-mm-dd')|| '~' ||to_char(to_date(#strEndDt#),'yyyy-mm-dd') AS INFO_YR /* 정보년도 */,
...
FROM TB_CSPBII170M WHERE SBMSN_YMD BETWEEN #strStrDt# AND #strEndDt#