/*감사업무 기여율*/ SELECT D3.EVL_YR /* 평가년도 */,
...
FROM TBCSPAOE023M WHERE EVL_YR = #strEvlYr# AND HLYR_DVSN_CD = #strHlyrDvsnCd# AND PTCPT_CNB = #strCnb# GROUP BY EVL_YR, HLYR_DVSN_CD, TSK_NO, PTCPT_CNB) AS CTB_RT /*기여율*/ , ( SELECT SUM(D1.DRIVE_RTE) AS DRIVE_RTE
...
FROM TBCSPAOE022M WHERE EVL_YR = #strEvlYr# AND HLYR_DVSN_CD = #strHlyrDvsnCd# AND TSK_NO = (SELECT TSK_NO
FROM TBCSPAOE023M WHERE EVL_YR = #strEvlYr# AND HLYR_DVSN_CD = #strHlyrDvsnCd# AND PTCPT_CNB = #strCnb#)) ) AS DRIVE_RTE FROM TBCSPAOE023M D1 , TBCSPAOE021M D3 , TBCSPAOE022M D4 WHERE 1=1 AND D1.EVL_YR = D3.EVL_YR AND D1.HLYR_DVSN_CD = D3.HLYR_DVSN_CD AND D1.TSK_NO = D3.TSK_NO AND D1.EVL_YR = D4.EVL_YR AND D1.HLYR_DVSN_CD = D4.HLYR_DVSN_CD AND D1.TSK_NO = D4.TSK_NO AND D1.EVL_YR = #strEvlYr# AND D1.HLYR_DVSN_CD = #strHlyrDvsnCd# AND D1.PTCPT_CNB = #strCnb# GROUP BY D3.EVL_YR, D3.HLYR_DVSN_CD, D3.ADT_KDCD, D3.TSK_NO, D3.ADT_MTTR_NM, D1.PTCPT_CNB UNION ALL /*감사외업무 기여율*/ SELECT D3.EVL_YR /* 평가년도 */,
    D3.HLYR_DVSN_CD /* 반기구분 */,
    ...
    0 /* 추진율 */
FROM TBCSPAOE025M D1 , TBCSPAOE024M D3 WHERE 1=1 AND D1.EVL_YR = D3.EVL_YR AND D1.HLYR_DVSN_CD = D3.HLYR_DVSN_CD AND D1.TSK_NO = D3.TSK_NO AND D1.EVL_YR = #strEvlYr# AND D1.HLYR_DVSN_CD = #strHlyrDvsnCd# AND D1.PTCPT_CNB = #strCnb# GROUP BY D3.EVL_YR, D3.HLYR_DVSN_CD, D3.TASK_KDCD, D3.TSK_NO, D3.TSK_NO, D3.TSK_NM, D1.PTCPT_CNB UNION ALL /*지원업무 기여율*/ SELECT D1.EVL_YR /* 평가년도 */,
    ...
    0 /* 추진율 */
FROM TBCSPAOE027M D1 , TBCSPAOE026M D2 WHERE 1=1 AND D1.EVL_YR = D2.EVL_YR AND D1.HLYR_DVSN_CD = D2.HLYR_DVSN_CD AND D1.TSK_NO = D2.TSK_NO AND D1.EVL_YR = #strEvlYr# AND D1.HLYR_DVSN_CD = #strHlyrDvsnCd# AND D1.PTCPT_CNB = #strCnb#