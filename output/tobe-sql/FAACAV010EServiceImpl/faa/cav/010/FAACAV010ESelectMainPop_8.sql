/* faa/cav/010/FAACAV010ESelectMainPop_8 */ SELECT CASE WHEN SUM_SE_ID='51' THEN '월계' ELSE CASE WHEN SUM_SE_ID='49' THEN '합계' ELSE SUM_SE_ID END END AS SUM_SE_ID /* 합계구분아이디 */,
    JRSD_CD /* 소관코드 */,
    ACNTG_CD /* 회계코드 */,
    BLL_KDCD /* 계산서종류코드 */,
    ...
    PRVTM_EXPND_AMT /* 전기지출금액 */,
    TQR_RTN_AMT /* 본분기반납금액 */,
    TQR_SBJCT_RCTF_AMT /* 본분기과목경정금액 */,
    FUND_EXPND_SBTR_AMT /* 기금지출차감금액 */,
