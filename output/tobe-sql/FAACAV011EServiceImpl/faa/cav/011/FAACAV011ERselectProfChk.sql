/* faa/cav/011/FAACAV011ERselectProfChk */ SELECT AA.PROF_DRTR_CD,
    AA.EANSUBJCD,
...
FROM TWFAACAV062L WHERE ACNTG_YR = #ACNTG_YR# GROUP BY ACNTG_YR,JRSD_CD,ACNTG_CD,BLL_KDCD,PROF_RBPRSN_SQNO,GVMNFC_OPER_EPS_RCDB_PBOFC_SQNO HAVING COUNT(DISTINCT ACNTG_YR||ACTNO_SCRTY||ACNT_SBJCT_SECD) > 1 ) BB WHERE AA.PROF_DRTR_CD = BB.PROF_DRTR_CD