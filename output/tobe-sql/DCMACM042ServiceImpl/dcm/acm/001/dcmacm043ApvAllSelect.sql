...
FROM TB_BADEAR001M D1 ,TB_BADEAR002D D2 WHERE D1.CVLCPT_ADT_YR = D2.ADT_YR AND D1.ADT_NO = D2.ADT_NO AND D1.DSPS_RQT_SQNO = D2.DSPS_RQT_SQNO AND D2.ATRZ_DOC_NO = T22.ATRZ_DOC_NO) ELSE NULL END AS ADT_MTTR_NM , AD.AUD_DOC_NM , '' AS MNG_DPT_NM , F_DPT_INFO(T22.APV_DPT_CD,'4') AS APV_DPT_NM FROM TBDCMACM022L T22, TBDCMACM023L T23, TBDCMACM021M T21 , ( SELECT A.ADT_YR /* 감사년도 */,
    A.ADT_NO /* 감사번호 */,
    C.ADT_KDCD /* 감사종류코드 */,
