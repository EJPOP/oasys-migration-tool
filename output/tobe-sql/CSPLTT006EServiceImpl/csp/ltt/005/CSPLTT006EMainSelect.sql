SELECT DECODE(A.NTFCTN_RCPT_SQNO,NULL,'',A.ACP_YE||'-'||A.NTFCTN_RCPT_SQNO) AS NTFCTN_RCPT_SQNO /* 통보접수순번 */,
    ...
    A.NAM_OPEN_YN,
    A.RLS_YMD /* 공개일자 */,
    61 - (TO_DATE(TO_CHAR(SYSDATE,'YYYYMMDD')) - TO_DATE(A.RLS_YMD)) AS 61 /* 숨김일자 */,
