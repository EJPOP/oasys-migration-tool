...
FROM TBCSPKDE007M D1 WHERE 1=1 AND NVL(D1.PRGRS_STTS_SECD,'07') NOT IN ('01','02') AND D1.INFO_RLPR_NM = #INFO_RLPR_NM# AND SUBSTR(D1.CRU_RRNO_SCRTY,0,6) = SUBSTR(#strEin#,0,6)