...
FROM TBCSPSAE101C A , TBCSPSAE102C B , TBCSPSAE103C C , TBCSPSAE201D D WHERE B.EDU_DVSN_CD = A.EDU_DVSN_CD AND C.EDU_DVSN_CD = B.EDU_DVSN_CD AND C.EDU_CAT_CD = B.EDU_CAT_CD AND D.CRS_CD = C.CRS_CD AND SUBSTR(D.EDU_BGNG_YMD, 0, 6) BETWEEN SUBSTR(#strFromYm#, 0, 6) AND SUBSTR(#strToYm#, 0, 6) AND A.EDU_DVSN_CD = #strEDU_DVSN_CD# AND B.EDU_CAT_CD = #strEDU_CAT_CD# AND C.CRS_CD = #strEDU_CRS_CD# AND D.CRS_CDN = #CRS_CDN# ORDER BY D.EDU_BGNG_YMD, A.EDU_DVSN_CD, B.EDU_CAT_CD, C.CRS_CD, D.CRS_CDN