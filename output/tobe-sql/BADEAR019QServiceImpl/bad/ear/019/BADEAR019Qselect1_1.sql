/*쿼리명 : SQL_Detail*/ select case when SUBSTR(KIKGU, 1, 1) = '1' then '1' when SUBSTR(KIKGU, 1, 1) = '2' then '2' when SUBSTR(KIKGU, 1, 1) = '3' then '3' else '4' end AS SUBSTR,
    case when SUBSTR(KIKGU, 1, 1) = '1' then '국가기관' when SUBSTR(KIKGU, 1, 1) = '2' then '자치단체' when SUBSTR(KIKGU, 1, 1) = '3' then '공공기관' else '기타단체' end AS SUBSTR,
