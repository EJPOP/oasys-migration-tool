WITH BASE AS ( select MAIN.INST_SECD ,DE04.CFMTN_STTS_SECD ,DE04.IMPL_WHLS_CFMTN_YMD ,MAIN.DSPS_RQT_KDCD ,DE04.PNRT_PRSRV_AMT ,DE04.RMBR_AMT ,DE04.SPLP_AMT ,DE04.NOP_CONT ,CASE SUBSTR(MAIN.INST_SECD,1,1) WHEN '1' THEN '1' WHEN '2' THEN '2' WHEN '3' THEN '3' ELSE '4' END KIKAN_KBN ,CASE WHEN NVL(DE04.CFMTN_STTS_SECD, '0') = '2' AND DE04.IMPL_WHLS_CFMTN_YMD #strStdDt#) THEN '2' /*집행중*/ END JIBHANG_KBN from TB_BADEAR001M MAIN ,TB_BADEAR002D DE04 where 1=1 and MAIN.ADT_YR = DE04.ADT_YR and MAIN.ADT_NO = DE04.ADT_NO and MAIN.DSPS_RQT_SQNO = DE04.DSPS_RQT_SQNO and NVL(DE04.CFMTN_STTS_SECD, '0') != '0' and DE04.ENFC_YMD BETWEEN #strFromDt# and #strToDt# /*화면 FROM ~TO*/ and ((NVL(DE04.CFMTN_STTS_SECD, '0') = '2' AND DE04.IMPL_WHLS_CFMTN_YMD #strStdDt#))) /*기준일*/ ) ,GROUP_BASE AS ( select CASE WHEN GROUPING(KIKAN_KBN) = '1' THEN '0' ELSE KIKAN_KBN END AS GROUPING,
...
from BASE group by rollup(KIKAN_KBN) ,rollup(CASE WHEN JIBHANG_KBN ='1' THEN '집행완료' WHEN JIBHANG_KBN ='2' THEN '집행중' END) UNION ALL SELECT to_char(LEVEL-1) AS TO_CHAR,
    '집행률(%)' AS CODE2,
    0,
    0,
    0,
    ...
    0,
    0
FROM DUAL CONNECT BY LEVEL <=5 ) SELECT DECODE(NVL(CODE1,'0'),'0', '전체합계', '1', '국가기관', '2' ,'자치단체','3','공공기관' ,'4' , '기타단체') AS CODE1,
    CODE1,
    CODE2,
    SUM_CNT,
