SELECT F_USR_INFO(B.LAG_INV_CNB,'2') AS F_USR_INFO /* 대출자명 */,
    LAG_INV_CNB,
    NVL(F_CODE_NM('1000144',F_USR_INFO(B.LAG_INV_CNB,'5')),' ') AS CNSTN_MBCMT_DEPT_NM /* 자문위원부서명 */,
