SELECT CASE WHEN AGT_CNB IS NOT NULL THEN F_USR_INFO(B.LAG_INV_CNB,'2')||'('||F_USR_INFO(B.AGT_CNB,'2')||')' ELSE F_USR_INFO(B.LAG_INV_CNB,'2') END AS AGT_CNB /* 대출자명 */,
    ...
    DECODE(B.BOO_REN_YN_CD,'0',B.BOO_REN_APT_DT,'') AS BOO_REN_YN_CD /* 도서반납예정일 */,
    A.BOO_NO /* 도서번호 */,
